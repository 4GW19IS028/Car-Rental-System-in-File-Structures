...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(LandingForm::typeid));
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(233, 268);
			...
			this->button2->Click += gcnew System::EventHandler(this, &LandingForm::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &LandingForm::button1_Click);
			// 
			// textBox2
			// 
			...
			this->textBox2->Location = System::Drawing::Point(180, 184);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(46, 188);
			...
			this->pictureBox1->Location = System::Drawing::Point(440, 11);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(46, 354);
			this->label4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(323, 26);
			this->label4->TabIndex = 26;
			this->label4->Text = L"Rental User...Create Account";
			this->label4->Click += gcnew System::EventHandler(this, &LandingForm::label4_Click);
			// 
			// LandingForm
			// 
			...
			this->ClientSize = System::Drawing::Size(855, 451);
